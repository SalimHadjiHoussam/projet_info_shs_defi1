...
let chargeAPI = 0;
    ...
    xhr1.open("GET","https://data.enseignementsup-recherche.gouv.fr/api/explore/v2.1/catalog/datasets/fr-esr-principaux-diplomes-et-formations-prepares-etablissements-publics/records/?limit=99&offset=0&select=annee_universitaire%2C+etablissement_lib%2C+libelle_intitule_1%2C+niveau_lib%2C+hommes%2C+femmes&where=annee_universitaire+in+%28%222021-22%22%2C%222022-23%22%2C%222023-24%22%2C%222024-25%22%29+AND+etablissement_lib+%3D+%22Universit%C3%A9+Toulouse+-+Jean+Jaur%C3%A8s%22+AND+libelle_intitule_1%3D%22Mathematiques+et+informatique+appliquees+aux+sciences+humaines+et+sociales%22+AND+niveau_lib%3D%223%C3%A8me+ann%C3%A9e%22");
